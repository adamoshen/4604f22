...
From Brightspace, download the `bisect.R` file. Then source the script to get it into your global
environment.
...
You will also need to adjust this line to be `<=` rather than `<`, otherwise you will get weird
results...
